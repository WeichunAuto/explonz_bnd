...
use crate::components::ui::sidenav::{
    ...
    SidenavHeader, SidenavLink, SidenavMenu, SidenavSide, SidenavWrapper,
};
...
const COMPONENT_LINKS: &[(&str, &str)] = &[
    ...
    (
        "/view/sidenav11/docs/components/alert-dialog",
        "Alert Dialog",
    ),
...
const HOOKS_LINKS: &[(&str, &str)] = &[
    (
        "/view/sidenav11/docs/hooks/use-copy-clipboard",
        "Use Copy Clipboard",
    ),
    (
        "/view/sidenav11/docs/hooks/use-lock-body-scroll",
