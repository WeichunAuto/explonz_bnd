...
use crate::components::ui::sidenav::{
    ...
    SidenavInput, SidenavLink, SidenavMenu, SidenavMenuSub, SidenavWrapper,
};
...
pub fn Sidenav03Routes() -> impl MatchNestedRoutes + Clone {
    view! {
        <ParentRoute path=StaticSegment(SidenavRoutes::view_segment()) view=|| view! { <Outlet /> }>
            <ParentRoute
                path=StaticSegment(SidenavRoutes::Sidenav03.as_ref())
                view=move || view! { <SidenavLayout sidenav_route=SidenavRoutes::Sidenav03 /> }
            >
    ...
    view! {
        <div class="bg-background">
            <SidenavWrapper attr:style="--sidenav-width:16rem;">
                ...
                <Sidenav>
                    <Sidenav03Content current_section sidenav_route />
                </Sidenav>
...
#[component]
fn Sidenav03Content(current_section: Memo<ExplonzRoutes>, sidenav_route: SidenavRoutes) -> impl IntoView {
...
#[component]
pub fn Sidenav03MobileSheet(current_section: Memo<ExplonzRoutes>, sidenav_route: SidenavRoutes) -> impl IntoView {
    view! {
        <Sheet>
...
const COMPONENT_LINKS: &[(&str, &str)] = &[
    ("/view/sidenav03/docs/components/accordion", "Accordion"),
    ("/view/sidenav03/docs/components/alert", "Alert"),
    ("/view/sidenav03/docs/components/alert-dialog", "Alert Dialog"),
    ("/view/sidenav03/docs/components/button", "Button"),
    ("/view/sidenav03/docs/components/card", "Card"),
    ("/view/sidenav03/docs/components/checkbox", "Checkbox"),
    ("/view/sidenav03/docs/components/dialog", "Dialog"),
];

const HOOKS_LINKS: &[(&str, &str)] = &[
    ("/view/sidenav03/docs/hooks/use-copy-clipboard", "Use Copy Clipboard"),
    ("/view/sidenav03/docs/hooks/use-lock-body-scroll", "Use Lock Body Scroll"),
    ("/view/sidenav03/docs/hooks/use-random", "Use Random"),
];
