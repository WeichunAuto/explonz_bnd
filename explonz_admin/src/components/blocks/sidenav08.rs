...
use crate::components::ui::sidenav::{
    ...
    SidenavLink, SidenavMenu, SidenavMenuItem, SidenavMenuSub, SidenavVariant, SidenavWrapper,
};
...
pub fn Sidenav08Routes() -> impl MatchNestedRoutes + Clone {
    view! {
        <ParentRoute path=StaticSegment(SidenavRoutes::view_segment()) view=|| view! { <Outlet /> }>
            <ParentRoute
                path=StaticSegment(SidenavRoutes::Sidenav08.as_ref())
                view=move || view! { <SidenavLayout sidenav_route=SidenavRoutes::Sidenav08 /> }
            >
                <SidenavRoutesSimplified data_variant=SidenavVariant::Inset />
            </ParentRoute>
        </ParentRoute>
    }
    .into_inner()
    ...
    view! {
        <div class="bg-background">
            <SidenavWrapper attr:style="--sidenav-width:16rem;">
                // * Desktop Sidenav (hidden on mobile) - Inset variant
                <Sidenav variant=SidenavVariant::Inset>
                    <Sidenav08Content current_section sidenav_route />
                </Sidenav>
...
#[component]
fn Sidenav08Content(current_section: Memo<ExplonzRoutes>, sidenav_route: SidenavRoutes) -> impl IntoView {
...
#[component]
pub fn Sidenav08MobileSheet(current_section: Memo<ExplonzRoutes>, sidenav_route: SidenavRoutes) -> impl IntoView {
    view! {
        <Sheet>
...
const COMPONENT_LINKS: &[(&str, &str)] = &[
    ("/view/sidenav08/docs/components/accordion", "Accordion"),
    ("/view/sidenav08/docs/components/alert", "Alert"),
    ("/view/sidenav08/docs/components/alert-dialog", "Alert Dialog"),
    ("/view/sidenav08/docs/components/button", "Button"),
    ("/view/sidenav08/docs/components/card", "Card"),
    ("/view/sidenav08/docs/components/checkbox", "Checkbox"),
    ("/view/sidenav08/docs/components/dialog", "Dialog"),
];

const HOOKS_LINKS: &[(&str, &str)] = &[
    ("/view/sidenav08/docs/hooks/use-copy-clipboard", "Use Copy Clipboard"),
    ("/view/sidenav08/docs/hooks/use-lock-body-scroll", "Use Lock Body Scroll"),
    ("/view/sidenav08/docs/hooks/use-random", "Use Random"),
];
